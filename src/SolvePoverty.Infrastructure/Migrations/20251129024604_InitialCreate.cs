        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FulfilledByUserId = table.Column<int>(type: "int", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_HelpRequests_Users_FulfilledByUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_HelpOffers_HelpRequests_HelpRequestId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HelpOffers_HelpRequestId",
                table: "HelpOffers",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HelpRequests_FulfilledByUserId",
                table: "HelpRequests",
